 ...
 * Users can provide their own RapidAPI key through the Settings modal.
 * 
 * To use the API:
 * 1. Get the API key from the submission comments
 * 2. Open the Settings modal in the application
 * 3. Enter the API key in the "RapidAPI Key" field
 * 4. Click "Save Settings"
 * 
 * Alternatively, to use your own API key:
